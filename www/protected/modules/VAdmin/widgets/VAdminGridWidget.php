...
class VAdminGridWidget extends CGridView {
    ...
    public $beforeListContent = '';
    public $afterListContent = '';
    ...
    public function renderBeforeList()
    {
        echo $this->beforeListContent;
    }

    public function renderAfterList()
    {
        echo $this->afterListContent;
    }
    ...
    public function registerClientScript()
    {
        ...
        $script = "
vapp.module.register( '".__CLASS__.'_'.$id."', vGrid, ".$options.");";
